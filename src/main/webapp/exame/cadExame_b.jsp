...
<head>
<meta charset="UTF-8">
<title><s:text name="label.titulo.pagina.exame.consulta"></s:text></title>
<link rel='stylesheet'
		...
		<div class="row">
			<table class="table table-light table-striped align-middle">
					...
					<s:iterator value="exames">
						<tr>
							...
							<td class="text-end"><s:url action="editarExames"
								...
								</s:url> <a href="${editar}" class="btn"> 
								<img width="40px" alt="editar" src="imagens/editar.png">
							</a> <s:url action="deletarExames" var="deletar">
									<s:param name="exameVo.rowid" value="rowid"></s:param>
								</s:url> <a href="#" data-id="${deletar}" class="btn mx-3"
				...
				<tfoot class="table-secondary">
					<tr>
						<td colspan="3"><s:url action="novoExames" var="novo" /> 
