...
public class AgendamentoSoapVo {
	...
	public AgendamentoSoapVo() {}

	public AgendamentoSoapVo(Integer rowid, FuncionarioVo funcionario, ExameVo exame, LocalDate dataAgendamento) {
		super();
		this.rowid = rowid;
	...
	public AgendamentoSoapVo(FuncionarioVo funcionario, ExameVo exame, LocalDate dataAgendamento) {
		this.funcionario = funcionario;
		this.exame = exame;
		this.dataAgendamento = dataAgendamento;
	}
